...
subroutine fb_rot_plus_env(vec_fb_loc,vec_fb,DpS2S,DmS2S,kx,nkx,nkr,nkO,nkr_loc)
implicit none
integer, intent(in) :: nkx,nkr,nkO,nkr_loc
complex(kind=8),intent(in) :: vec_fb(nkx,nkr,-nkO:nkO,3)
real (kind=8), intent(in)  :: DpS2S(nkr,nkr_loc,-nkO-1:nkO+1),&
                              DmS2S(nkr,nkr_loc,-nkO-1:nkO+1),kx(nkx)
complex(kind=8),intent(inout):: vec_fb_loc(nkx,nkr_loc,-nkO-1:nkO+1,3)
integer         :: ik_loc,ik,iO
complex(kind=8) :: sliceKR(nkx), ii=(0.0d0,1.0d0)
...
subroutine fb_rot_minus_env(vec_fb_loc,vec_fb,DpS2S,DmS2S,kx,nkx,nkr,nkO,nkr_loc)
implicit none
integer, intent(in) :: nkx,nkr,nkO,nkr_loc
complex(kind=8),intent(in) :: vec_fb(nkx,nkr,-nkO-1:nkO+1,3)
real (kind=8), intent(in)  :: DpS2S(nkr,nkr_loc,-nkO-1:nkO+1),&
                              DmS2S(nkr,nkr_loc,-nkO-1:nkO+1),kx(nkx)
complex(kind=8),intent(inout):: vec_fb_loc(nkx,nkr_loc,-nkO:nkO,3)
integer         :: ik_loc,ik,iO
