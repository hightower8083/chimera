...
real (kind=8), intent(in)  :: DpS2S(nkr,nkr_loc,0:nkO),&
                              DmS2S(nkr,nkr_loc,0:nkO),kx(nkx)
complex(kind=8) :: scl_fb_loc(nkx,nkr_loc,0:nkO)
integer         :: ik_loc,ik,iO
...
do iO=0,nkO
  ...
  do ik_loc=1,nkr_loc
    ...
    if (iO>0) then
      ...
      do ik=1,nkr
        sliceKR = sliceKR + DmS2S(ik,ik_loc,iO)*(ii*aux_comp(:,ik,2)-aux_comp(:,ik,1))
      enddo
    endif
    if (iO<nkO) then
      do ik=1,nkr
...
do iO=0,nkO
  !$omp do schedule(static)
  do ik_loc=1,nkr_loc
    vec_fb(:,ik_loc,iO,1) = vec_fb(:,ik_loc,iO,1) + ii*kx*scl_fb_loc(:,ik_loc,iO)
...
subroutine fb_graddiv_ext(vec_fb,DpS2S,DmS2S,kx,nkx,nkr,nkO,nkr_loc)
implicit none
integer, intent(in) :: nkx,nkr,nkO,nkr_loc
complex(kind=8),intent(inout) :: vec_fb(nkx,nkr,0:nkO,3)
...
subroutine fb_rot_plus(vec_fb_loc,vec_fb,DpS2S,DmS2S,kx,nkx,nkr,nkO,nkr_loc)
implicit none
integer, intent(in) :: nkx,nkr,nkO,nkr_loc
complex(kind=8),intent(in) :: vec_fb(nkx,nkr,0:nkO,3)
real (kind=8), intent(in)  :: DpS2S(nkr,nkr_loc,0:nkO+1),&
                              DmS2S(nkr,nkr_loc,0:nkO+1),kx(nkx)
complex(kind=8),intent(inout):: vec_fb_loc(nkx,nkr_loc,0:nkO+1,3)
integer         :: ik_loc,ik,iO
complex(kind=8) :: sliceKR(nkx), ii=(0.0d0,1.0d0),vec_fb_ext(nkx,nkr,3)
...
subroutine fb_rot_minus(vec_fb_loc,vec_fb,DpS2S,DmS2S,kx,nkx,nkr,nkO,nkr_loc)
implicit none
integer, intent(in) :: nkx,nkr,nkO,nkr_loc
complex(kind=8),intent(in) :: vec_fb(nkx,nkr,0:nkO+1,3)
real (kind=8), intent(in)  :: DpS2S(nkr,nkr_loc,0:nkO+1),&
                              DmS2S(nkr,nkr_loc,0:nkO+1),kx(nkx)
complex(kind=8),intent(inout):: vec_fb_loc(nkx,nkr_loc,0:nkO,3)
integer         :: ik_loc,ik,iO
...
subroutine fb_grad_ext(vec_fb_loc,scl_fb,DpS2S,DmS2S,kx,nkx,nkr,nkO,nkr_loc)
implicit none
integer, intent(in) :: nkx,nkr,nkO,nkr_loc
complex(kind=8),intent(in) :: scl_fb(nkx,nkr,0:nkO)
real (kind=8), intent(in)  :: DpS2S(nkr,nkr_loc,0:nkO+1),&
